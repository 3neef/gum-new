...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#brand_phones" role="tab" data-toggle="tab">
                {{ trans('cruds.phone.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="brand_phones">
            @includeIf('admin.brands.relationships.brandPhones', ['phones' => $brand->brandPhones])
        </div>
    </div>
</div>
